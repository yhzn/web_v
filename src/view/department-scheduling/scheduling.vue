...
<script>
  ...
  import headData from '@/data/department-scheduling-title.json'
  import rotateIcon from '../../../static/image/icon/rotate.png'
  import searchInput from '../../../static/image/department-scheduling/2.1.png'
  import searchFir from '../../../static/image/department-scheduling/2.2.png'
