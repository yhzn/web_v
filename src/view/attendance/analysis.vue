...
<script>
  ...
  import headData from '@/data/attendance-title.json'
  import rotateIcon from '../../../static/image/icon/rotate.png'
  import searchInput from '../../../static/image/attendance/2.1.png'
  import searchFir from '../../../static/image/attendance/2.2.png'
  import imgList from '@/components/new-img-list.vue'
  let imgData=[
    {
      headImg:rotateIcon,
      headTitle:"会议人员考勤统计分析",
