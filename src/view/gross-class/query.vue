...
<script>
  ...
  import headData from '@/data/gross-class-title.json'
  import rotateIcon from '../../../static/image/icon/rotate.png'
  import searchInput from '../../../static/image/gross-class/2.1.png'
  import searchFir from '../../../static/image/gross-class/2.2.png'
