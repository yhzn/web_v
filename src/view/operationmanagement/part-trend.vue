...
<script>
  ...
  import searchInput from '../../../static/image/operation/part41.png'
  import searchInputOne from '../../../static/image/operation/part42.png'

  let imgData=[
    {
      headImg:rotateIcon,
      headTitle:"手术及有创完成情况分布图",
      img:[searchInput]
    },
    {
      headImg:rotateIcon,
      headTitle:"手术及有创完成情况统计表",
      img:[searchInputOne]
    }
  ]
  export default {
