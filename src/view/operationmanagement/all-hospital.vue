...
<script>
  ...
  import searchInput from '../../../static/image/operation/all21.png'
  import searchInputOne from '../../../static/image/operation/all22.png'

  let imgData=[
    {
      headImg:rotateIcon,
      headTitle:"全院各科室手术例数分布图",
      img:[searchInput]
    },{
      headImg:rotateIcon,
      headTitle:"全院各科室手术例数统计表",
      img:[searchInputOne]
    }
  ]
  export default {
