...
<script>
  ...
  import searchInput from '../../../static/image/operation/all11.png'
  import searchInputOne from '../../../static/image/operation/all12.png'

  let imgData=[
    {
      headImg:rotateIcon,
      headTitle:"全院手术总例数分布图",
      img:[searchInput]
    },{
      headImg:rotateIcon,
      headTitle:"全院手术总例数统计表",
      img:[searchInputOne]
    }
  ]
  export default {
