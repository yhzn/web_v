...
<script>
  ...
  import searchInput from '../../../static/image/operation/all101.png'
  import searchOne from '../../../static/image/operation/all102.png'

  let imgData=[
    {
      headImg:rotateIcon,
      headTitle:"全院手术及有创操作同比及环比统计分析表",
      img:[searchInput,searchOne]
    }
  ]
  export default {
    data () {
