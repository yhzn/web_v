...
<script>
  ...
  import headData from '@/data/adverse-event-title.json'
  import rotateIcon from '../../../static/image/icon/rotate.png'
  import searchInput from '../../../static/image/adverse-event/pending-approval1.png'
  import searchInputOne from '../../../static/image/adverse-event/pending-approval2.png'
