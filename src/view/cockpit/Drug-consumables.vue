...
<script>
  ...
  import searchInput from '../../../static/image/cockpit/ThematicSupport/1.1.png'
  import searchInputOne from '../../../static/image/cockpit/ThematicSupport/1.2.png'
  import imgList from '@/components/new-img-list.vue'
  let imgData=[
    {
      headImg:rotateIcon,
      headTitle:"药品耗材",
      headSubTitle:"院区药材占比监控及费用明细信息",
