...
<script>
  ...
  import searchInput from '../../../static/image/cockpit/operational performance/5.1.png'
  import searchInputOne from '../../../static/image/cockpit/operational performance/5.2.png'
