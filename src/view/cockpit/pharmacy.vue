...
<script>
  ...
  import searchInput from '../../../static/image/cockpit/chief-inquiry/yj1.1.png'
  import searchInputOne from '../../../static/image/cockpit/chief-inquiry/yj1.2.png'
  import imgList from '@/components/new-img-list.vue'
  let imgData=[
    {
      headImg:rotateIcon,
      headTitle:"药学部",
      headSubTitle:"针对各医技使用药品及处方的统计分析",
